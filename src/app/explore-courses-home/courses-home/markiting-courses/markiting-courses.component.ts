...
@Component({
  selector: 'app-markiting-courses',
  imports: [CommonModule, FormsModule,NavbarComponent,CoursesHomeComponent],
  templateUrl: './markiting-courses.component.html',
  styleUrl: './markiting-courses.component.css'
})
export class MarkitingCoursesComponent implements OnInit{
