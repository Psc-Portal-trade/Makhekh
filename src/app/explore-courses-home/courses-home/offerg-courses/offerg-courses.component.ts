...
@Component({
  ...
  imports: [NavbarComponent,CoursesHomeComponent,CommonModule, FormsModule],
  templateUrl: './offerg-courses.component.html',
  styleUrl: './offerg-courses.component.css'
})
export class OffergCoursesComponent implements OnInit {
