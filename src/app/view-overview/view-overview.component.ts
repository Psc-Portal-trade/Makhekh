...
@Component({
  ...
  imports: [FormsModule, CommonModule, StudentReviewsComponent, SecondNavComponent],
...
export class ViewOverviewComponent implements OnInit{
  ...
  constructor(private qaService: QaService ,private reviewService: ReviewService,private route: ActivatedRoute,private courseService: CourseInformationService) {
